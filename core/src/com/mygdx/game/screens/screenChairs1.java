...
import items.Items;
import items.itemFlash;
import npc.DialogWithNPC;
import npc.NPC;
import npc.npcKatya;
import player.Player;

public class screenChairs1 implements Screens {	
	...
	//конструктор сцены
	public screenChairs1(final AiL game) {
		this.game = game;//инициализация объекта класса игры
		//загрузка изображений
		background = new Texture(Gdx.files.internal("Chairs1.png"));	
		...
		npcList.add(new npcKatya(game, this));
		npcList.get(0).setCoords(800/2 - npcList.get(0).getRectangle().width/2, 0, 170, 300);
		...
		itemList.add(new itemFlash(player, this));
