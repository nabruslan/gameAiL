...
public class screenLadder implements Screens {	
	...
	//конструктор сцены
	public screenLadder(final AiL game) {
		this.game = game;//инициализация объекта класса игры
		//загрузка изображений
		background = new Texture(Gdx.files.internal("Ladder.png"));	
		...
		npcList.add(new npcMasha(game, this));
		npcList.get(0).setCoords(800/2 - npcList.get(0).getRectangle().width/2, 0, 80, 290);
		...
		itemList.add(new itemBook(player, this));
