...
import items.Items;
import items.itemPaper;
import npc.DialogWithNPC;
import npc.NPC;
import npc.npcLena;
import player.Player;

public class screenPad2 implements Screens {	
	...
	//конструктор сцены
	public screenPad2(final AiL game) {
		this.game = game;//инициализация объекта класса игры
		//загрузка изображений
		background = new Texture(Gdx.files.internal("Pad2.png"));	
		...
		npcList.add(new npcLena(game, this));
		...
		itemList.add(new itemPaper(player, this));
