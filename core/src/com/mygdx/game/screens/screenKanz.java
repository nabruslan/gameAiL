...
import npc.NPC;
import npc.npcAutomat;
import player.Player;

public class screenKanz implements Screens {	
	...
	//конструктор сцены
	public screenKanz(final AiL game) {
		this.game = game;//инициализация объекта класса игры
		//загрузка изображений
		background = new Texture(Gdx.files.internal("Kanz.png"));	
		...
		npcList.add(new npcAutomat(game, this));
		npcList.get(0).setCoords(800/2 - npcList.get(0).getRectangle().width/2, 10, 150, 350);
		...
		itemList.add(new itemChocolate(player, this));
