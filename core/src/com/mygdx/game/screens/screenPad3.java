...
import items.Items;
import items.itemCoin;
import npc.DialogWithNPC;
import npc.NPC;
import npc.npcTrash;
import player.Player;

public class screenPad3 implements Screens {	
	...
	//конструктор сцены
	public screenPad3(final AiL game) {
		this.game = game;//инициализация объекта класса игры
		//загрузка изображений
		background = new Texture(Gdx.files.internal("Pad3.png"));	
		...
		npcList.add(new npcTrash(game, this));
		npcList.get(0).setCoords(250, 20, 80, 100);
		...
		itemList.add(new itemCoin(player, this));
