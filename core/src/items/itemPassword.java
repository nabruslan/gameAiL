...
public class itemPassword implements Items{
	Player player;//игрок
	...
	public itemPassword(Player player, Screens screen) {//конструктор	
		this.player = player;//инициализация игрока
		this.screen = screen;//получаем сцену
		
		itemIcon = new Texture(Gdx.files.internal("password.png"));//загрузка изображения
		...
		info = "Странная бумажка с текстом";//инициализация информации
		name = "itemPassword";//инициализация названия
