...
public class itemBook implements Items{
	Player player;//игрок
	...
	public itemBook(Player player, Screens screen) {//конструктор	
		this.player = player;//инициализация игрока
		this.screen = screen;//получаем сцену
		
		itemIcon = new Texture(Gdx.files.internal("book.png"));//загрузка изображения
		...
		info = "Просто книжка";//инициализация информации
		name = "itemBook";//инициализация названия
