...
public class itemCoin implements Items{
	Player player;//игрок
	...
	public itemCoin(Player player, Screens screen) {//конструктор	
		this.player = player;//инициализация игрока
		this.screen = screen;//получаем сцену
		
		itemIcon = new Texture(Gdx.files.internal("coin.png"));//загрузка изображения
		...
		info = "Монетка";//инициализация информации
		name = "itemCoin";//инициализация названия
