 ...
 * Пример класса предмета, реализующий интерфейс Items*/

public class itemApple implements Items{
	Player player;//игрок
	...
	public itemApple(Player player, Screens screen) {//конструктор	
		this.player = player;//инициализация игрока
		this.screen = screen;//получаем сцену
		
		itemIcon = new Texture(Gdx.files.internal("apple.png"));//загрузка изображения
		...
		info = "Огрызок от яблока";//инициализация информации
		name = "itemApple";//инициализация названия
