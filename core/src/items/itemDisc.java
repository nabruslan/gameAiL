...
public class itemDisc implements Items{
	Player player;//игрок
	...
	public itemDisc(Player player, Screens screen) {//конструктор	
		this.player = player;//инициализация игрока
		this.screen = screen;//получаем сцену
		
		itemIcon = new Texture(Gdx.files.internal("disc.png"));//загрузка изображения
		...
		info = "Редкая пластинка";//инициализация информации
		name = "itemDisc";//инициализация названия
