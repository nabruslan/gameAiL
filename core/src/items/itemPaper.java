...
public class itemPaper implements Items{
	Player player;//игрок
	...
	public itemPaper(Player player, Screens screen) {//конструктор	
		this.player = player;//инициализация игрока
		this.screen = screen;//получаем сцену
		
		itemIcon = new Texture(Gdx.files.internal("paper.png"));//загрузка изображения
		...
		info = "Газета \"Электрик\"";//инициализация информации
		name = "itemPaper";//инициализация названия
