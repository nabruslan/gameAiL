...
public class itemNotes implements Items{
	Player player;//игрок
	...
	public itemNotes(Player player, Screens screen) {//конструктор	
		this.player = player;//инициализация игрока
		this.screen = screen;//получаем сцену
		
		itemIcon = new Texture(Gdx.files.internal("notes.png"));//загрузка изображения
		...
		info = "Нотный лист с нотами";//инициализация информации
		name = "itemNotes";//инициализация названия
