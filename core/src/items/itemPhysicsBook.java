...
public class itemPhysicsBook implements Items{
	Player player;//игрок
	...
	public itemPhysicsBook(Player player, Screens screen) {//конструктор	
		this.player = player;//инициализация игрока
		this.screen = screen;//получаем сцену
		
		itemIcon = new Texture(Gdx.files.internal("physicsBook.png"));//загрузка изображения
		...
		info = "Учебник по физике";//инициализация информации
		name = "itemPhysicsBook";//инициализация названия
