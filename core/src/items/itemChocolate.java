...
public class itemChocolate implements Items{
	Player player;//игрок
	...
	public itemChocolate(Player player, Screens screen) {//конструктор	
		this.player = player;//инициализация игрока
		this.screen = screen;//получаем сцену
		
		itemIcon = new Texture(Gdx.files.internal("chocolate.png"));//загрузка изображения
		...
		info = "Вкусная шоколадка";//инициализация информации
		name = "itemChocolate";//инициализация названия
